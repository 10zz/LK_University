...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 17 2025 г., 14:48
...
(1, 'Программирование', 'Изучение языков программирования и алгоритмов', 'icons/study/code.png'),
(2, 'Математика', 'Высшая математика и математический анализ', 'icons/study/math.png'),
(3, 'Физика', 'Классическая и современная физика', 'icons/study/physics.png'),
(4, 'Химия', 'Органическая и неорганическая химия', 'icons/study/chemistry.png');
...
CREATE TABLE `StudyMaterials` (
  ...
  `material_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `StudyMaterials` (`material_id`, `title`, `description`, `material_type`, `icon_path`, `link`) VALUES
(1, 'Основы программирования', 'УбиватьУбиватьУбиватьУбиватьУбиватьУбивать', 'курс лекций', 'icons/book.png', 'https://example.com/materials/programming'),
(2, 'Базы данных', 'УбиватьУбиватьУбиватьУбиватьУбиватьУбиватьУ', 'презентация', 'icons/presentation.png', 'https://example.com/materials/database'),
(3, 'Математический анализ', 'УбиватьУбиватьУбиватьУбиватьУбиватьУбиватьБ', 'учебник', 'icons/textbook.png', 'https://example.com/materials/math'),
(4, 'Лабораторная работа по физике', 'УбиватьУбиватьУбиватьУбиватьУбиватьУбиватьИ', 'практика', 'icons/lab.png', 'https://example.com/materials/physics_lab');
